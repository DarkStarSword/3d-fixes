...
cd extracted
"$DIR/extract_unity_shaders.py" */*.shader --type=d3d9 --type=d3d11
cd ShaderCRCs
...
"$DIR/shadertool.py" -I ../.. --stereo-sampler-ps=s15 --adjust-input=texcoord4 --ignore-other-errors Ceto_OceanUnderSide_BRDF/fp/*
# "$DIR/shadertool.py" -I ../.. --stereo-sampler-ps=s15 --adjust-input=v0 --adjust-input=v1 --adjust-multiply=0.5 Beam\ Team_Ocean_OceaB/fp/*
