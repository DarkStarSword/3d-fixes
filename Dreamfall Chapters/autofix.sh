...
# TODO: Combine --auto-fix-vertex-halo and --fix-unity-reflection
"$DIR/shadertool.py" -I ../.. --fix-unity-reflection --add-fog-on-sm3-update --only-autofixed --ignore-register-errors */vp/*.txt >> ../../DX9Settings.ini
