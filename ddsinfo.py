...
d3d9_pixel_formats = {
	...
	# MAKEFOURCC('UYVY'): ('D3DFMT_UYVY',
	# MAKEFOURCC('RGBG'): ('D3DFMT_R8G8_B8G8',
	# MAKEFOURCC('YUY2'): ('D3DFMT_YUY2',
	# MAKEFOURCC('GRGB'): ('D3DFMT_G8R8_G8B8',
	# MAKEFOURCC('DXT1'): ('D3DFMT_DXT1',
	# MAKEFOURCC('DXT2'): ('D3DFMT_DXT2',
	# MAKEFOURCC('DXT3'): ('D3DFMT_DXT3',
	# MAKEFOURCC('DXT4'): ('D3DFMT_DXT4',
	# MAKEFOURCC('DXT5'): ('D3DFMT_DXT5',
	# MAKEFOURCC('MET1'): ('D3DFMT_MULTI2_ARGB8',
